...
- [ ] Provision E2E secrets/fixtures beyond ABS content: a known server TLS cert + fingerprint (E2E-01 trust-on-first-use) and ABS user credentials + the low-privilege streamer account (E2E-02) — revisit tracked in [#11](https://github.com/Xexanos/ratatoskr-e2e/issues/11) (likely resolved by per-run generation)
