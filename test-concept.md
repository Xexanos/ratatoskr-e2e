...
- [ ] Define staging/fixture data for ABS in E2E — revisit tracked in [#10](https://github.com/Xexanos/ratatoskr-e2e/issues/10) (likely already covered by `make-fixture.sh` + `seed-abs.sh`)
